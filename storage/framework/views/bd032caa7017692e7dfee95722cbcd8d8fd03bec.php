<section class="row work-experience-section-one-row">
        ...
        <div class="col-sm-6 col-md-6">        
            ...
            <div class="jumbotron p-3 p-md-5 rounded custom-jumbotron tech-skills-section-front-end">
                ...
                <p class="mg-btm-4">Create A lightweight bespoke wordpress theme that would load and deliver fast pages, on mobile and desktop.</p>

                <p class="mg-btm-4">Implement a fully responsive UI, that could be integrated into the Wordpress CMS.</p>

                <p class="mg-btm-4">Integrate the Woocommerce plugin into the build to facilitate transactions on the website.</p>

                <p class="mg-btm-4">Build, a well optimized and high performance based website, using SEO Metric tools (GTMetrix & Google Page Speed) and modify the site architecture according to metric results.</p>
    ...
    </section><?php /**PATH /home/chido/Downloads/chidodesignsapp/resources/views/inc/work-experience-page/experience-one.blade.php ENDPATH**/ ?>