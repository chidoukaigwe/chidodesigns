    ...
    <div class="col-sm-12 col-md-12">
        ...
        <div class="jumbotron p-3 p-md-5 rounded custom-jumbotron projects-shareposts-app-section-jumbotron" style="background-color: #f2f2f2;"> 
            ...
            <ul class="mg-btm-4">
                ...
                <li>Understand the seperation of concerns, behind the MVC design pattern .</li>
            </ul>
            ...
            <p class="mg-btm-4">
                ...
                <br><br>
                The Application is structured similarly to the Laravel/Slim/Symfony frameworks. Separating the public folder from the core app build and enabling a bootstrap file to initialise the app. The code is easy to read and maintain and enables efficient codebase scaling.
            </p>
...
</section><?php /**PATH /home/chido/projects/laravel-projects/chidodesignsapp/resources/views/inc/projects-page/shareposts-app.blade.php ENDPATH**/ ?>