<section class="row featured-work-section">
        ...
        <div class="col-sm-12 col-md-12">
                ...
                <div class="jumbotron p-3 p-md-5 rounded custom-jumbotron" style="background-color: #f2f2f2;">
                    ...
                    <h1 class="mg-btm-4 text-center">Jolocs</h1>

                    <div class="row featured-work-row">

                            <div class="col-sm-12 col-md-12">

                                <strong><small> Salon - Wordpress (in development) </small></strong>
                                <h4 class="mt-1"> <a href="https://www.instagram.com/locsbyjo/?hl=en" target="_blank">Jolocs</a></h4>
                                <p class="mg-btm-2">Providing a Personal Service for Locs & Natural Hair.</p>
...
<?php /**PATH /home/chido/projects/laravel-projects/chidodesignsapp/resources/views/inc/clients-page/client-jolocs.blade.php ENDPATH**/ ?>