<section class="row featured-work-section">
        ...
        <div class="col-sm-12 col-md-12">
                ...
                <div class="jumbotron p-3 p-md-5 rounded custom-jumbotron">
                    ...
                    <h1 class="mg-btm-4 text-center">Rehangit</h1>
                    ...
                    <div class="row featured-work-row">
                            ...
                            <div class="col-sm-12 col-md-12">
                                ...
                                <p class="mg-btm-4">
                                    Create an e-commerce marketplace whereby users could signup, list their clothes that they would want to sell, and let the Rehangit platform facilitate the transaction. Rehangit would take a small commission of each sale and would give the rest of the proceeds to the vendor.
                                    Users (Vendors/Sellers) would have a dashboard on the backend whereby they could upload and sell their products, and track their sales. General customers would have to create an account in order to purchase any item listed on the site.
                                </p>
                                
                                <img src="images/case-studies/rehangit/rehangitcasestudy2.png" alt="Rehangit Case Study Image" class="mg-btm-4">
                    ...
                    <div class="btn-holder text-center chido-designs-welcome-section-btn"> 
                        <a href="https://www.rehangit.com/" target="_blank">
...
</section><?php /**PATH /home/chido/projects/laravel-projects/chidodesignsapp/resources/views/inc/clients-page/client-two.blade.php ENDPATH**/ ?>