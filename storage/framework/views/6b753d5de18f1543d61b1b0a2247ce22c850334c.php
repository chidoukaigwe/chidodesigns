<section class="row work-experience-section-one-row">
        ...
        <div class="col-sm-6 col-md-6">        
            ...
            <div class="jumbotron p-3 p-md-5 rounded custom-jumbotron tech-skills-section-front-end">
                ...
                <p class="mg-btm-6">Writing PHP code, and maintaining the current codebase.</p>

                <p class="mg-btm-6">Adding feature requests as the 2nd developer, and planning out how the features will be integrated into the current codebase.</p>

                <p class="mg-btm-6">I was tasked with setting up a development workflow from scratch:</p>

                <p class="mg-btm-4">Local Development Setup</p>

                <p class="mg-btm-4">Staging Development Setup</p>

                <p class="mg-btm-4">Bitbucket as web repo host.</p>
    ...
    </section><?php /**PATH /home/chido/Downloads/chidodesignsapp/resources/views/inc/work-experience-page/experience-two.blade.php ENDPATH**/ ?>